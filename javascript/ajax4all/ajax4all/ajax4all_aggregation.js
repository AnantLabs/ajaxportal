...
///////////////////////////////////////////////////////////////////
    ...
    function deleteLastDirectory(str) {
        var cstr = str;
        if (str.charAt(str.length - 1) == "/") {
            cstr = str.substr(0, str.length-1);
        }
        var slashPos = cstr.lastIndexOf("/");
        return cstr.substr(0, slashPos);
    ...
    function aggregateContent(request, target, _defaultPath) {
        ...
        if ((defaultPath.length > 0) && (defaultPath.charAt(0) == "/")) {
            defaultPath = deleteLastDirectory(basePath) + defaultPath;
        }
