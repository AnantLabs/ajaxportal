...
public class HttpRequestWrapper {
    ...
    @Deprecated
    Enumeration getHeaders(String s) {          // TODO: refactor
    ...
    @Deprecated
    int getIntHeader(String s) {               // TODO: refactor
    ...
    @Deprecated
    boolean isUserInRole(String s) {              // TODO: refactor
    ...
    @Deprecated
    HttpSession getSession(boolean b) {           // TODO: refactor
