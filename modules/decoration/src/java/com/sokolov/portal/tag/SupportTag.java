...
public class SupportTag extends TagSupport {
    ...
    public int doStartTag() throws JspException {
        try {
            pageContext.getOut().print(createLink("region_nodecoration_common.css"));
            pageContext.getOut().print(createLink("region_window_common.css"));
            pageContext.getOut().print(createLink("region_standard_common.css"));
            pageContext.getOut().print(createLink("region_accordion_common.css"));
            pageContext.getOut().print(createLink("region_tabs_common.css"));

            pageContext.getOut().print(createLink("region_window_" + getTheme() + ".css", "portletWindow"));
            pageContext.getOut().print(createLink("region_standard_" + getTheme() + ".css", "portletStandard"));
            pageContext.getOut().print(createLink("region_accordion_" + getTheme() + ".css", "portletAccordion"));
            pageContext.getOut().print(createLink("region_tabs_" + getTheme() + ".css", "portletTabs"));
            ...
            pageContext.getOut().print(createScript("region.js"));
            pageContext.getOut().print(createScript("portal.js"));

            pageContext.getOut().print(createScript("options.js"));
